...
export function TableForm({ day, time, teacher, color, setColor, setTeacher, subject, setSubject, description, setDescription, isOpen, setOpen, tableValue, setTableValue }: Props) {

  const colors: string[] = ["#eb7b7b", "#e9a4c9", "#f39ff3", "#c3a2ef", "#a09ff4", "#abcbf3", "#b0eeef", "#ace9c7", "#b1f0a7", "#cdefa5", "#ebeba3", "#ffbd79"]
